...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dout2, grads['dW2'], grads['db2'] = affine_backward(dout3, cache3)
        dout1 = relu_backward(dout2, cache2)
        grads['dx'], grads['dW1'], grads['db1'] = affine_backward(dout1, cache1)
        print("reg term for W1", self.reg*np.linalg.norm(self.params['W1']))
        grads['dW1']+=self.reg*self.params['W1']
        grads['dW2']+=self.reg*self.params['W2']
